<div class="min-h-[80vh] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h2 class="mt-4 text-2xl font-extrabold text-slate-900 tracking-tight">Set a new password</h2>
        <p class="mt-1.5 text-xs text-slate-500">Please choose a strong password to secure your account.</p>
    </div>
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md px-4 sm:px-0">
        <div class="bg-white py-8 px-6 shadow-xl shadow-slate-200/50 sm:rounded-3xl border border-slate-100 sm:px-10">
            ...
            <form wire:submit.prevent="submit" class="space-y-4">
                ...
                <div>
                    <label for="password" class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1">New Password</label>
                ...
                <div>
                    <label for="password_confirmation" class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1">Confirm New Password</label>
